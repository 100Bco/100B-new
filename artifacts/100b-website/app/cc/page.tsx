...
export const metadata: Metadata = {
  title: "Container Club — The Private Trade Network",
  description:
    "Container Club is 100B's vetted, introduction-only network of cross-border trade operators — freight vendors, customs brokers, verified buyers, factory reps, trade-finance specialists — across the US–Vietnam corridor.",
  alternates: { canonical: "/cc" },
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <Link href="/trade" className="border border-brand-gold/50 text-brand-gold hover:bg-brand-gold/10 rounded-full px-8 py-4 text-xs uppercase tracking-widest font-semibold transition-colors w-full sm:w-auto text-center">
                  Back to Trade
                </Link>
              </div>
            </div>
