      ...
      <section className="py-20 lg:py-28 bg-bg-alt border-b border-border-subtle">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            {/* Trade — gold gradient frame around a dark interior.
                Moving text off the metal fixes contrast for older readers while
                keeping the gold signal as a recognizable accent. */}
            <div className="bg-gold-gradient rounded-3xl p-[3px] shadow-[0_20px_60px_-25px_rgba(0,0,0,0.9)]">
            ...
            {/* Build — silver gradient frame, same dark interior. */}
            <div
