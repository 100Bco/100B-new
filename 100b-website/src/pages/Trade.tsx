    ...
    <div className="flex flex-col">
      ...
      <section className="py-20 bg-bg-alt text-center flex flex-col items-center justify-center border-b border-border-subtle">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <Link to="/cc" className="inline-flex items-center gap-3 text-sm uppercase tracking-widest font-semibold text-white hover:text-brand-gold transition-colors group">
